...
type TarsiMascotProps = {
  size?: number;
  mood?: 'happy' | 'thinking';
};

export function TarsiMascot({ size = 82, mood = 'happy' }: TarsiMascotProps) {
  return (
    <View style={[styles.shell, { height: size, width: size, borderRadius: size / 2 }]}>
      <Svg width={size} height={size} viewBox="0 0 96 96">
        <Circle cx="48" cy="48" r="44" fill="#DFF3E7" />
        ...
        <Path d="M44 54 Q48 58 52 54" stroke="#1B4332" strokeWidth="3" strokeLinecap="round" fill="none" />
        <Path
        ...
        <Circle cx="75" cy="58" r="6" fill={palette.green} />
      </Svg>
    </View>
  );
}
